...
curl --proto '=https' --tlsv1.2 -fsSLo /tmp/install-hmr-dual.sh \
  https://raw.githubusercontent.com/l1lchucky/chronalyn/v1.0.0/scripts/install-dual.sh \
...
```bash
./scripts/install-dual.sh --wheel /path/to/chronalyn-1.0.0-py3-none-any.whl
```
